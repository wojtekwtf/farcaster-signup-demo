export const IdGatewayABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_storageRegistry", type: "address" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "extraStorage", type: "uint256" },
    ],
    name: "price",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract IStorageRegistry", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
