export const KeyRegistryABI = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_maxKeysPerFid", type: "uint256" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "AlreadyMigrated", type: "error" },
  { inputs: [], name: "ExceedsMaximum", type: "error" },
  ...
  { inputs: [], name: "InvalidMaxKeys", type: "error" },
  ...
  },
  {
    ...
    name: "keysOf",
    outputs: [
      { internalType: "bytes[]", name: "page", type: "bytes[]" },
      { internalType: "uint256", name: "nextIdx", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "_keyGateway", type: "address" }],
    name: "setKeyGateway",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
